...
int main() {
    ...
    unsigned int floorTexture = loadTexture(FileSystem::getPath("resources/textures/dirt.jpeg").c_str());
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 Bview = programState->camera.GetViewMatrix();
        ...
        glm::mat4 modelCube = glm::translate(model, glm::vec3(-2.25f, 0.5f, -0.8f));
        blendingShader.setMat4("model", modelCube);
        ...
        blendingShader.setMat4("model", Bmodel);
        ...
        {
            Bmodel = glm::mat4(1.0f);
            Bmodel = glm::translate(Bmodel, glm::vec3(0.0f, -0.00f, 0.0f));
            Bmodel = glm::translate(Bmodel, grass[i]);
            blendingShader.setMat4("model", Bmodel);
            glDrawArrays(GL_TRIANGLES, 0, 6);
        }
        ...
        skyboxShader.use();
        glm::mat4 viewSky = glm::mat4(glm::mat3(programState->camera.GetViewMatrix())); // remove translation from the view matrix
